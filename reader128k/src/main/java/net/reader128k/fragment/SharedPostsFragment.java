...
public class SharedPostsFragment extends Fragment {
    private List<TreeNode> mTree = new ArrayList<TreeNode>();
    private SharedPostsAdapter mSharedPostsAdapter;
    private final static String TAG = LogUtils.makeLogTag(SharedPostsFragment.class);



    public static SharedPostsFragment newInstance(List<TreeNode> tree) {
        SharedPostsFragment fragment = new SharedPostsFragment();
        fragment.mTree = tree;
        return fragment;
    }

    public SharedPostsFragment() {}
